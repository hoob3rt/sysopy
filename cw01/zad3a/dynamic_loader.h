...
struct table* (*create_table)(int64_t);
int64_t (*get_operations_count_from_block)(struct block*);
struct file_sequence* (*define_sequence_of_files)();
struct file_sequence* (*create_sequence_from_array)(char**, int);
struct table* (*create_table_from_sequence)(struct file_sequence*);
...
void init_dynamic_handler() {
    ...
    *(void**)(&free_block) = dlsym(handle, "free_block");
    ...
    *(void**)(&define_sequence_of_files) =
        dlsym(handle, "define_sequence_of_files");
    *(void**)(&create_sequence_from_array) =
        dlsym(handle, "create_sequence_from_array");
    *(void**)(&create_table_from_sequence) =
        dlsym(handle, "create_table_from_sequence");
